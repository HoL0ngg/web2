...
document.querySelectorAll(".plus").forEach((button) => {
  button.addEventListener("click", async function () {
    ...
    if (currentQuantity < hihi) {
      ...
      updateCart();
    } else showToast("Sản phẩm đã hết hàng", false);
  });
});
...
if (document.getElementById("cart-thanhtoan"))
  document
    .getElementById("cart-thanhtoan")
      ...
      fetch("handles/getSession.php")
        ...
        .then((data) => {
          ...
          if (!data.success) {
            ...
            return;
          } else window.location.href = "cart.php?action=thanhtoan";
        });
